        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span className="w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-center text-indigo-400 font-mono text-sm font-bold">PE</span>
              <div>
                <p className="font-semibold text-slate-100">{portfolioConfig.name}</p>
                <p className="text-xs text-slate-500">{portfolioConfig.title}</p>
              </div>
            </div>
          ...
          <div>
            ...
            <nav aria-label="Footer navigation">
              <ul className="space-y-2">
                ...
                <li>
                  <a href={portfolioConfig.social.github} target="_blank" rel="noopener noreferrer" className="text-sm text-slate-400 hover:text-indigo-400 transition-colors inline-flex items-center gap-1">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-100 mb-4">Status</h3>
            <div className="flex items-center gap-2 mb-3">
              <span className="status-dot" />
              <span className="text-sm text-slate-400">Available for projects</span>
            </div>
            <p className="text-xs text-slate-500">Currently focused on web development, Python, and full-stack learning.</p>
          </div>
        </div>
        <div className="mt-12 pt-6 border-t border-slate-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">© 2026 {portfolioConfig.name}. All rights reserved.</p>
