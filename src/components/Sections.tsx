  ...
  return (
    <section className="py-20 md:py-28 relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text mb-4">
              Code. Build. Commit. Repeat.
            </h2>
            <p className="text-text-muted leading-relaxed mb-8">
              My GitHub contains experiments, learning projects, applications, and ongoing development work. Every commit represents progress.
            </p>
            <a
              href={portfolioConfig.social.github}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-surface-lighter border border-border hover:border-primary/50 text-text font-medium rounded-lg transition-all hover:shadow-lg"
            >
              <Github size={18} />
              View GitHub Profile
            </a>
        ...
        {/* GitHub stats decoration */}
        <ScrollReveal delay={200}>
          <div className="mt-12 grid grid-cols-3 gap-4 max-w-md mx-auto">
            {[
              { label: "Repositories", value: "Active" },
              { label: "Contributions", value: "Growing" },
              { label: "Status", value: "Building" },
            ].map((stat) => (
              <div key={stat.label} className="text-center p-4 rounded-lg border border-border bg-surface/40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <SectionHeading
            ...
            description="What I'm actively working on and improving."
          />
        </ScrollReveal>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {currentlyBuildingItems.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 80}>
              <div className="p-6 rounded-xl border border-border bg-surface/40 hover:border-primary/30 transition-all group h-full">
...
const experienceItems = [
  {
    ...
    description: "Building personal projects and experimental applications. Learning through building real things.",
    tags: ["Self-directed", "Project-based"],
  },
  {
    title: "Project-Based Development",
    description: "Designing and implementing websites and web applications with focus on functionality and clean code.",
    tags: ["Web Development", "Problem Solving"],
  },
  {
    title: "Continuous Learning",
    description: "Studying programming, software development, APIs, Git, backend concepts and modern web development practices.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <SectionHeading
            ...
            description="My development experience is built through projects, learning, and consistent practice."
          />
        </ScrollReveal>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {experienceItems.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 100}>
              <div className="p-6 rounded-xl border border-border bg-surface/40 hover:border-primary/30 transition-colors h-full">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.tags.map((tag) => (
                    <span key={tag} className="px-2 py-0.5 text-xs text-text-dim bg-surface-lighter rounded border border-border">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <SectionHeading
            ...
            description="Practical development services focused on delivering functional, well-built digital products."
          />
        </ScrollReveal>
          ...
          {services.map((service, i) => (
            <ScrollReveal key={service.title} delay={i * 80}>
              <div className="p-6 rounded-xl border border-border bg-surface/40 hover:border-primary/30 transition-all group h-full">
                ...
                <h3 className="text-base font-semibold text-text mb-2">{service.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <SectionHeading
            ...
            description="How I approach development and collaboration."
          />
        </ScrollReveal>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
          {whyWorkWithMe.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 80}>
              <div className="p-5 rounded-xl border border-border bg-surface/40 hover:border-primary/30 transition-colors h-full">
